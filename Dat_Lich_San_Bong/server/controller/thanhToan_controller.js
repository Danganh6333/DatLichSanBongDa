const { ThanhToan } = require("../model/thanhToan_model");
const mongoose = require("mongoose");

exports.addTransactions = async (req, res, next) => {
    var accessKey = 'F8BBA842ECF85';
    var secretKey = 'K951B6PE1waDMi640xX08PD3vg6EkVlz';
    var orderInfo = 'Thanh Toán Lịch';
    var partnerCode = 'MOMO';
    var redirectUrl = 'https://webhook.site/b3088a6a-2d17-4f8d-a383-71389a6c600b';//Vị trí khi thanh toán xong
